 ...
 */
function getRouteFromHash(hash: string): 'dashboard' | 'transactions' | 'budgets' {
...
function AppInner() {
  ...
  const [route, setRoute] = useState<'dashboard' | 'transactions' | 'budgets'>(() => getRouteFromHash(window.location.hash));

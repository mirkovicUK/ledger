...
/**
 * AddTransaction — create or edit a transaction.
 *
 * Props:
 *   accounts       — array of { id, name }
 *   categories     — array of { id, name }
 *   initialValues  — optional transaction for edit mode
 *                    { amount, date, description, accountId, categoryId }
 *   onSubmit(payload) — called with { amount, date, description, accountId, categoryId }
...
export function AddTransaction({ accounts = [], categories = [], initialValues, onSubmit, onCancel }) {

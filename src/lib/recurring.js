 ...
 *
 * @param {import('./types.js').RecurringRule} rule
 * @param {string} referenceDate - YYYY-MM-DD
 * @param {() => string} idGenerator
 * @returns {{ transactions: object[], updatedRule: object }}
 */
export function expandRule(rule, referenceDate, idGenerator) {
  ...
  let newLastExpandedDate = rule.lastExpandedDate;
  ...
  const updatedRule = { ...rule, lastExpandedDate: newLastExpandedDate };
 ...
 *
 * @param {object[]} rules - Array of RecurringRule objects
 * @param {object[]} existingTransactions - Already-stored transactions
 * @param {string} referenceDate - YYYY-MM-DD
 * @param {() => string} idGenerator
 * @returns {{ transactions: object[], updatedRules: object[] }}
 */

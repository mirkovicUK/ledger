...
import type { TransactionFormPayload } from '../components/AddTransaction.jsx';
...
export default function Transactions(): JSX.Element {
  ...
  function handleAddTxSubmit(payload: TransactionFormPayload) {
    dispatch({
  ...
  function handleEditTxSubmit(payload: TransactionFormPayload) {
    dispatch({

...
describe('expandRule – transaction fields', () => {
  it('each transaction carries the correct fields from the rule', () => {
    const rule = makeRule({
      frequency: 'monthly',
      startDate: '2024-01-01',
      amount: 99.99,
  ...
  it('each transaction gets a unique id from the generator', () => {
  ...
  it('categoryId defaults to null when not set on rule', () => {
